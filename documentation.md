...
The example below defines a post study survey component for the experiment.
...
Different types of stimuli can be added to an experiment ([React](#react-components), [Image](#image-components) and [Website](#website-components) Components). This section details how to import different types of stimuli into ReVISit.
#### React Components
