...
4. **Simple data storage** — no need to run your own servers: data is stored in a relatively easy to set-up Firebase/Supabase instance. Of course, you can also self-hosted server if you want full control.
...
[Visualization Guardrails: Designing Interventions Against Cherry-Picking in Interactive Data Explorers](https://www.visdesignlab.net/publications/2025_chi_guardrails/).
SIGCHI Conference on Human Factors in Computing Systems (CHI), 1-19, [doi:10.1145/3706598.3713385](https://dl.acm.org/doi/10.1145/3706598.3713385), 2025.
:::
