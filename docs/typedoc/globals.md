...
- [MatrixQuestionOption](interfaces/MatrixQuestionOption.md)
...
- [ParsedMatrixQuestionOption](interfaces/ParsedMatrixQuestionOption.md)
...
- [NextButtonAlignment](type-aliases/NextButtonAlignment.md)
