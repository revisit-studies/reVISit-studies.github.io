...
Defined in: [parser/types.ts:656](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L656)
...
| <a id="optionorder"></a> `optionOrder?` | `"fixed"` \| `"random"` | The order in which the buttons are displayed. Defaults to fixed. | - | [parser/types.ts:660](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L660) |
| <a id="options"></a> `options` | (`string` \| [`StringOption`](StringOption.md))[] | - | - | [parser/types.ts:658](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L658) |
...
| <a id="type"></a> `type` | `"buttons"` | - | - | [parser/types.ts:657](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L657) |
