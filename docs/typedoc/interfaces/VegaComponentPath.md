...
Defined in: [parser/types.ts:772](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L772)
...
| <a id="path"></a> `path` | `string` | The path to the vega file. This should be a relative path from the public folder. | - | [parser/types.ts:775](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L775) |
...
| <a id="type"></a> `type` | `"vega"` | - | - | [parser/types.ts:773](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L773) |
