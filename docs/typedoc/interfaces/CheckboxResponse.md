...
Defined in: [parser/types.ts:768](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L768)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="default"></a> `default?` | `string`[] | The default value of the response. Specify an array of option values. To preselect the "I don't know" checkbox, include `"I don't know"`. | - | [parser/types.ts:773](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L773) |
...
| <a id="horizontal"></a> `horizontal?` | `boolean` | Whether to render the checkboxes horizontally. Defaults to false, so they render horizontally. | - | [parser/types.ts:781](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L781) |
...
| <a id="maxselections"></a> `maxSelections?` | `number` | The maximum number of selections that are required. | - | [parser/types.ts:779](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L779) |
| <a id="minselections"></a> `minSelections?` | `number` | The minimum number of selections that are required. | - | [parser/types.ts:777](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L777) |
| <a id="optionorder"></a> `optionOrder?` | `"random"` \| `"fixed"` | The order in which the checkboxes are displayed. Defaults to fixed. | - | [parser/types.ts:775](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L775) |
| <a id="options"></a> `options` | (`string` \| [`StringOption`](StringOption.md))[] | The options that are displayed as checkboxes, provided as an array of objects, with label and value fields. | - | [parser/types.ts:771](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L771) |
...
| <a id="type"></a> `type` | `"checkbox"` | - | - | [parser/types.ts:769](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L769) |
...
| <a id="withother"></a> `withOther?` | `boolean` | Whether to render the checkboxes with an "other" option. | - | [parser/types.ts:783](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L783) |
