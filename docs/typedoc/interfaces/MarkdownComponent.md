...
Defined in: [parser/types.ts:576](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L576)
...
| <a id="path"></a> `path` | `string` | The path to the markdown file. This should be a relative path from the public folder. | - | [parser/types.ts:579](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L579) |
...
| <a id="type"></a> `type` | `"markdown"` | - | - | [parser/types.ts:577](https://github.com/revisit-studies/study/blob/8321281ac346f1aa0a6d05a2638ef2608adef62e/src/parser/types.ts#L577) |
