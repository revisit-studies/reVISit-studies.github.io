...
| ------ | ------ | ------ | ------ | ------ |
| <a id="default"></a> `default?` | [`JsonValue`](../type-aliases/JsonValue.md) | The default value of the response. Must be JSON-serializable. | - | [parser/types.ts:854](https://github.com/revisit-studies/study/blob/72b8e5c4fa403736be782c35d94c86b3f785e056/src/parser/types.ts#L854) |
...
| <a id="parameters"></a> `parameters?` | `Record`\<`string`, `unknown`\> | Parameters passed to the custom response component. | - | [parser/types.ts:852](https://github.com/revisit-studies/study/blob/72b8e5c4fa403736be782c35d94c86b3f785e056/src/parser/types.ts#L852) |
| <a id="path"></a> `path` | `string` | The path to the react component. This should be a relative path from the src/public folder. | - | [parser/types.ts:850](https://github.com/revisit-studies/study/blob/72b8e5c4fa403736be782c35d94c86b3f785e056/src/parser/types.ts#L850) |
...
| <a id="type"></a> `type` | `"custom"` | - | - | [parser/types.ts:848](https://github.com/revisit-studies/study/blob/72b8e5c4fa403736be782c35d94c86b3f785e056/src/parser/types.ts#L848) |
