...
Defined in: [parser/types.ts:733](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L733)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="default"></a> `default?` | `string` | The default value of the response. Specify one option value as a string. | - | [parser/types.ts:738](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L738) |
...
| <a id="horizontal"></a> `horizontal?` | `boolean` | Whether to render the radio buttons horizontally. Defaults to false, so they render horizontally. | - | [parser/types.ts:748](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L748) |
...
| <a id="labellocation"></a> `labelLocation?` | `"above"` \| `"inline"` \| `"below"` | The location of the labels. This only works when horizontal is true. Defaults to inline. | - | [parser/types.ts:746](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L746) |
| <a id="leftlabel"></a> `leftLabel?` | `string` | The left label of the radio group. Used in Likert scales for example | - | [parser/types.ts:742](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L742) |
...
| <a id="optionorder"></a> `optionOrder?` | `"random"` \| `"fixed"` | The order in which the radio buttons are displayed. Defaults to fixed. | - | [parser/types.ts:740](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L740) |
| <a id="options"></a> `options` | (`string` \| [`StringOption`](StringOption.md))[] | The options that are displayed as checkboxes, provided as an array of objects, with label and value fields. | - | [parser/types.ts:736](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L736) |
...
| <a id="rightlabel"></a> `rightLabel?` | `string` | The right label of the radio group. Used in Likert scales for example | - | [parser/types.ts:744](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L744) |
...
| <a id="type"></a> `type` | `"radio"` | - | - | [parser/types.ts:734](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L734) |
...
| <a id="withother"></a> `withOther?` | `boolean` | Whether to render the radios with an "other" option. | - | [parser/types.ts:750](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L750) |
