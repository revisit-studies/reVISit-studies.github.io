...
Defined in: [parser/types.ts:425](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L425)
...
| <a id="questionoptions"></a> `questionOptions` | `string`[] | The question options (rows) are the prompts for each response you'd like to record. | - | [parser/types.ts:430](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L430) |
| <a id="questionorder"></a> `questionOrder?` | `"fixed"` \| `"random"` | The order in which the questions are displayed. Defaults to fixed. | - | [parser/types.ts:432](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L432) |
...
| <a id="type"></a> `type` | `"matrix-radio"` \| `"matrix-checkbox"` | - | - | [parser/types.ts:426](https://github.com/revisit-studies/study/blob/4a2d066376abc40f420535b2f018065ea046908c/src/parser/types.ts#L426) |
