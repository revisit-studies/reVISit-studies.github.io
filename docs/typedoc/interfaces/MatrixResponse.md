...
Defined in: [parser/types.ts:336](https://github.com/revisit-studies/study/blob/cc971c3a87dd8aa25af38cb8fdda41a9d7f7e906/src/parser/types.ts#L336)
...
| <a id="questionoptions"></a> `questionOptions` | `string`[] | The question options (rows) are the prompts for each response you'd like to record. | - | [parser/types.ts:341](https://github.com/revisit-studies/study/blob/cc971c3a87dd8aa25af38cb8fdda41a9d7f7e906/src/parser/types.ts#L341) |
...
| <a id="type"></a> `type` | `"matrix-radio"` \| `"matrix-checkbox"` | - | - | [parser/types.ts:337](https://github.com/revisit-studies/study/blob/cc971c3a87dd8aa25af38cb8fdda41a9d7f7e906/src/parser/types.ts#L337) |
