...
Defined in: [parser/types.ts:571](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L571)
...
| <a id="default"></a> `default?` | `Record`\<`string`, `string`\> | The default value of the response by question key. Provide an object where each key is a question value and each value is one answer option value. | - | [parser/types.ts:574](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L574) |
...
| <a id="type"></a> `type` | `"matrix-radio"` | - | - | [parser/types.ts:572](https://github.com/revisit-studies/study/blob/fb7b64f6ea729ee3d5a0457224326b40ce119176/src/parser/types.ts#L572) |
