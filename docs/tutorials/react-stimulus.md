...
**Example 1** is a stimulus from the graphical [perception experiment](https://www.tandfonline.com/doi/abs/10.1080/01621459.1984.10478080). This example will demonstrate how to pass data from the config file to the stimulus.
