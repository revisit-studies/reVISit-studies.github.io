...
![Live monitor](./img/live-monitor.png)
...
![Live monitor reconnect](./img/live-monitor-reconnect.png)
...
![Live monitor](./img/live-monitor-in-progress.png)
...
![Live monitor dynamic block](./img/live-monitor-in-progress-dynamic.png)
