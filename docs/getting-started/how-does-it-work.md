...
For examples of how to write a base component, refer to the [documentation](../typedoc/interfaces/StudyConfig#properties) and to the [relevant tutorial](../getting-started/your-first-study#adding-custom-html).
