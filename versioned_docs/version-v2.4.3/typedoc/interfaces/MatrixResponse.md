...
| <a id="questionoptions"></a> `questionOptions` | (`string` \| [`StringOption`](StringOption.md))[] | The question options (rows) are the prompts for each response you'd like to record. | - | [parser/types.ts:536](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L536) |
| <a id="questionorder"></a> `questionOrder?` | `"random"` \| `"fixed"` | The order in which the questions are displayed. Defaults to fixed. | - | [parser/types.ts:538](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L538) |
...
| <a id="type"></a> `type` | `"matrix-radio"` \| `"matrix-checkbox"` | - | - | [parser/types.ts:532](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L532) |
