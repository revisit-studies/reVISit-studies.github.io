...
The technical documentation can be found [here](../typedoc/globals). 
...
You can find the detailed documentation for the reVISit Spec [here](../typedoc/interfaces/StudyConfig).
...
For examples of how to write a base component, refer to the [documentation](../typedoc/interfaces/StudyConfig#properties) and to the [relevant getting started guide](../getting-started/your-first-study#adding-custom-html).
