...
Defined in: [parser/types.ts:770](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L770)
...
| <a id="optionorder"></a> `optionOrder?` | `"random"` \| `"fixed"` | The order in which the buttons are displayed. Defaults to fixed. | - | [parser/types.ts:774](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L774) |
| <a id="options"></a> `options` | (`string` \| [`StringOption`](StringOption.md))[] | - | - | [parser/types.ts:772](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L772) |
...
| <a id="type"></a> `type` | `"buttons"` | - | - | [parser/types.ts:771](https://github.com/revisit-studies/study/blob/317436dc2065f4bc80347c4bd7250d4444518b6d/src/parser/types.ts#L771) |
