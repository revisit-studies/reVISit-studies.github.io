...
Defined in: [parser/types.ts:608](https://github.com/revisit-studies/study/blob/d85836850c66a7e523578f6b0e32c1027d11846b/src/parser/types.ts#L608)
...
| <a id="numitems"></a> `numItems?` | `number` | The number of items to rank. Applies only to sublist and categorical ranking widgets. | - | [parser/types.ts:613](https://github.com/revisit-studies/study/blob/d85836850c66a7e523578f6b0e32c1027d11846b/src/parser/types.ts#L613) |
| <a id="options"></a> `options` | (`string` \| [`StringOption`](StringOption.md))[] | The options that are displayed as ranking options, provided as an array of objects, with label and value fields. | - | [parser/types.ts:611](https://github.com/revisit-studies/study/blob/d85836850c66a7e523578f6b0e32c1027d11846b/src/parser/types.ts#L611) |
...
| <a id="type"></a> `type` | `"ranking-sublist"` \| `"ranking-categorical"` \| `"ranking-pairwise"` | - | - | [parser/types.ts:609](https://github.com/revisit-studies/study/blob/d85836850c66a7e523578f6b0e32c1027d11846b/src/parser/types.ts#L609) |
