...
<div class="info-panel">
<div class="info-text">
By default, reVISit always uses local storage. Once the connection to Firebase is set up, you can test the connection by setting the <code>VITE_STORAGE_ENGINE</code> variable in the <code>.env</code> file to "firebase". See the <a href="#deploying-to-a-static-website">Deployment</a> section for more information about deploying your study to Github.io once the connection to Firebase has been set up. 
</div>
</div>
